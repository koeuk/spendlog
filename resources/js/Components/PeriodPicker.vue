...
<template>
    ...
    <SearchableSelect
        ...
        match-value
        trigger-class="h-9 min-w-32 rounded-xl border border-neutral-200 bg-white/70 px-3 text-xs font-semibold text-neutral-700 hover:bg-white dark:border-neutral-700 dark:bg-neutral-800/70 dark:text-neutral-200 dark:hover:bg-neutral-800"
