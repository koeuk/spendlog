            ...
            <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <SearchableSelect
                        ...
                        content-class="w-44"
                        trigger-class="h-8 rounded-xl border border-neutral-200 bg-white px-3 text-xs font-medium text-neutral-700 sm:w-44 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200"
